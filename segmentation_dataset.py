...
_PQR_SEG_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 830,  # number of file in the train folder
        'trainval': 1159,
        'val': 231,
    },
    num_classes=894,  # number of classes in your dataset
    ignore_label=894,  # white edges that will be ignored to be class
)
